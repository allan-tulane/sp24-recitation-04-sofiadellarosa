...
**Name (Team Member 1):** Jaimie Morris  
**Name (Team Member 2):** Sofia Della Rosa
...
**It is difficult to parallelize this solution because with multiple processes working in parallel, data might be updated to the same term, affecting the result.** 
