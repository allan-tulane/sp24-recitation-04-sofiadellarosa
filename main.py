...
def word_count_map(doc):
  ...
  return list(map(lambda x: (x, 1), doc.split()))  #done jaimie
...
def word_count_reduce(group):
  """
    ...
    """
  ###TODO
  return (group[0], reduce(lambda x, y: x + y, group[0],
                           group[1]))  #done jaimie
...
# testing part 1
print(word_count_map('i am sam i am'))  # correct
print(word_count_reduce(['i', [1, 1, 1]]))  # correct
print(
    run_map_reduce(word_count_map, word_count_reduce,
                   ['i am sam i am', 'sam is ham']))  # correct
